  ...
  //栏目管理路由
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'article_editor',
        meta: { title: '栏目编辑', icon: 'documentation', affix: true }
      },
    ]
  },
  //文章管理路由
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/pages/article/Editor'),
        name: 'article_editor',
        meta: { title: '文章编辑', icon: 'documentation', affix: true }
      }
    ]
  },
  //评论管理
    ...
    children: [
      {
        ...
        name: 'comment_list',
        meta: { title: '评论管理', icon: 'documentation', affix: true }
      }
    ]
  },
  //用户管理路由
    ...
    children: [
      {
        ...
        name: 'privilege_list',
        meta: { title: '权限管理', icon: 'documentation', affix: true }
      }
    ]
  },
